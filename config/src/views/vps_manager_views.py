...
from src.serializers.vps_manager_serializers import (
    VPSCreateSerializer,
    VPSStatusEditSerializer,
    VPSDetailSerializer,
)
from src.services.vps_manager_services import (
    VPSCreateSrv,
    VPSStatusEditSrv,
    get_vps_srv,
)
...
class ServerViewSet(ViewSet):
    ...
    def retrieve(self, *args, **kwargs):
        ...
        return Response(status=400, data={"Произошла ошибка"})
